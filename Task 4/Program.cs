class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Student[] students =
        [
            new Student("Anuska", new DateOnly(2004, 12, 2), "Male"),
            new Student("Ritika", new DateOnly(2004, 3, 5), "Male"),
            new Student("Shailja", new DateOnly(2006, 7, 23), "Male"),
            new Student("Lanee", new DateOnly(2005, 11, 9), "Female"),
            new Student("Divya", new DateOnly(2004, 2, 17), "Male"),
            new Student("Sita", new DateOnly(2006, 9, 30), "Female"),
            new Student("Subuu", new DateOnly(2005, 4, 14), "Male"),
            new Student("Deepti", new DateOnly(2004, 12, 1), "Female"),
            new Student("Prabesh", new DateOnly(2006, 6, 8), "Male"),
            new Student("Prajwal", new DateOnly(2005, 8, 21), "Female")
        ];
